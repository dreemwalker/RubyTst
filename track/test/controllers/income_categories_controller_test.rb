...
class IncomeCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create income_category" do
    assert_difference('IncomeCategory.count') do
      post income_categories_url, params: { income_category: { name: @income_category.name, userID: @income_category.userID } }
    end
  ...
  test "should update income_category" do
    patch income_category_url(@income_category), params: { income_category: { name: @income_category.name, userID: @income_category.userID } }
